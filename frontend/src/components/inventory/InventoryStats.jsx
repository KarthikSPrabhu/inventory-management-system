...
function InventoryStats({ items }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {/* Total Items Card */}
      <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-lg relative overflow-hidden">
        ...
        <h4 className="text-3xl font-extrabold text-slate-900 mt-4">{totalItems}</h4>
      </div>
      ...
      <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-lg relative overflow-hidden">
        ...
        <h4 className="text-3xl font-extrabold text-slate-900 mt-4">{totalQuantity}</h4>
      </div>
    </div>
  );
}
