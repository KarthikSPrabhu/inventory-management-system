...
function InventoryEmptyState() {
  return (
    <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-12 text-center flex flex-col items-center justify-center space-y-4">
      {/* Icon placeholder */}
      <div className="h-16 w-16 rounded-full bg-slate-950 flex items-center justify-center text-slate-600 border border-slate-850 shadow-inner select-none">
      ...
      <div className="space-y-1">
        <h4 className="text-base font-bold text-white tracking-tight">No inventory items yet.</h4>
